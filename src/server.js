...
export function createServer() {
  const server = instrumentServer(new McpServer({
    ...
    instructions: BRIDGE_PROFILE === "host" ? [
      ...
      "Use task-owned worktrees, attached existing directories, or exact-head existing branch attachments; follow repository instructions/hooks/checks, fresh Git/GitHub state, and explicit approval for high-impact actions.",
